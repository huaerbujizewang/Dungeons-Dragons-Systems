const storyContent = {
    ...
    lines: [
        ...
        { speaker: "婕萨敏", emotion: "婕萨敏", text: "如果有人愿意付钱买另一个人的命，这只是市场需求。在这个丛林里，生命本来就有价格。" },
        ...
        { speaker: "公诉人", emotion: "公诉人", text: "考虑到你深受某种坏死性诅咒的影响，医学鉴定团认为你已构成‘生物危害源’。" },
        ...
        { speaker: "公诉人", emotion: "公诉人", text: "在战时法律中，资助敌对异种族屠杀人类同胞，是不可饶恕的重罪。" },
        ...
        { speaker: "公诉人", emotion: "公诉人", text: "你不仅实施酷刑，更犯有勾结邪魔罪、传播邪教罪以及反人类罪。" },
        ...
        { speaker: "公诉人", emotion: "公诉人", text: "调查显示，当你‘奇迹般’生还并带回大量财宝时，你没有任何足以证明你通过合法手段获取财富的证据。" },
        ...
        { speaker: "瓦康嘎·欧塔姆", emotion: "瓦康嘎", text: "那些卷轴是用来对抗死亡诅咒的希望。至于竖琴手……他们是自由的斗士，不是间谍。" },
        ...
        // --- 艾珂内 ---
        { speaker: "艾珂内·阿法", emotion: "艾珂内", text: "你们怎么敢！看看窗外！那些平民手里的盾牌是我造的！" },
        ...
        { speaker: "公诉人", emotion: "公诉人", text: "在新的《武装解除令》下，任何私人向平民大规模出售军械的行为，都被视为煽动武装暴乱。" },
